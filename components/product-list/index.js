                        ...
                        <section className="w-30"
                            ...
                            <div className="card ma-16">
                                ...
                                <div className="card-actions justify-content-center pa-4">
                                    ...
                                    <button onClick={() => this.props.onAdd(i)} className="x-small outlined" data-testid="btn-item-add">
                                        Add To Cart
                                    </button>
                                    )}
                                    {product.cartQuantity === 1 && (
                                    <button onClick={() => this.props.onRemove(i)} className="x-small danger" data-testid="btn-item-remove">
                                        Remove
                                    </button>
                                    )}
                                </div>
